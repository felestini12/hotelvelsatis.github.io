...
(function($)
{
	...
	$('#book_now').click((e)=>{e.preventDefault();window.open('https://www.booking.com/hotel/ma/velsatis-beni-mellal.fr.html?aid=397594;label=gog235jc-1DCAEoggI46AdIDVgDaIwBiAEBmAENuAEXyAEM2AED6AEB-AECiAIBqAIDuALDgrCRBsACAdICJGU2OGE4MGJkLTU4NDUtNGY4OC05YjJhLWQzNzRlYmRjNWE5NtgCBOACAQ;sid=2d3a21794d8e35c2e7631b24a3913e90;dest_id=-26006;dest_type=city;dist=0;group_adults=2;group_children=0;hapos=1;hpos=1;no_rooms=1;req_adults=2;req_children=0;room1=A%2CA;sb_price_type=total;sr_order=popularity;srepoch=1647130213;srpvid=bbff0132420f0462;type=total;ucfs=1&#hotelTmpl', '_blank');});
	/* -- Room Section */
	...
	$(document).ready(function($) {
		...
		$('.read-more').click((e)=>{
			e.preventDefault();
			if ($(e.currentTarget).attr('class').includes('book_now'))
				window.open('https://www.booking.com/hotel/ma/velsatis-beni-mellal.fr.html?aid=397594;label=gog235jc-1DCAEoggI46AdIDVgDaIwBiAEBmAENuAEXyAEM2AED6AEB-AECiAIBqAIDuALDgrCRBsACAdICJGU2OGE4MGJkLTU4NDUtNGY4OC05YjJhLWQzNzRlYmRjNWE5NtgCBOACAQ;sid=2d3a21794d8e35c2e7631b24a3913e90;dest_id=-26006;dest_type=city;dist=0;group_adults=2;group_children=0;hapos=1;hpos=1;no_rooms=1;req_adults=2;req_children=0;room1=A%2CA;sb_price_type=total;sr_order=popularity;srepoch=1647130213;srpvid=bbff0132420f0462;type=total;ucfs=1&#hotelTmpl', '_blank')
			else
